...
training_args = TrainingArguments(
    output_dir="../model/llama2-lora-spanish",      
...
model.save_pretrained("../model/llama2-lora-spanish")
tokenizer.save_pretrained("../model/llama2-lora-spanish")

print("Modelo adaptado guardado en ../model/llama2-lora-spanish")
